...
of experience with Python, and have had some run-ins with C++ and Java. I'm also very comfortable with Linux, as I have been a full-time Linux (and occasionally Mac) user for almost 10 years.
...
* Dec 2023 - Aug 2024: **Software Engineering Working Student at [Forget Finance](https://forget.finance)**\
...
* Mar 2025 - Present: **Software Engineering Working Student at [Yacoub Automation](https://www.yacoub.de)** \
  At Yacoub, I'm working on low-level embedded software for safety-rated industrial automation devices using C, FreeRTOS and a diverse supporting toolchain involving Docker, CMake, OpenOCD, Renode, Ceedling, and various proprietary tools.
...
I haven't done much open source work and am not very experienced, so this list is quite short.
